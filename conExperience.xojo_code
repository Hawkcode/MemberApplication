#tag WebPage
Begin WebContainer conExperience
   Compatibility   =   ""
   Cursor          =   0
   Enabled         =   True
   Height          =   373
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Function SaveExperience() As Boolean
		  ...
		  oSQL.AddFields "expTo",     "expTo2",     "expTo3",      "expTo4",    "expTo5",     "expTo6",     "expTo7"
		  oSQL.AddValues txtTo.Text, txtTo2.Text, txtTo3.Text, txtTo4.Text, txtTo5.Text, txtTo6.Text, txtTo7.Text
		  
		  oSQL.AddFields "expAddress",      "expAddress2",      "expAddress3",    "expAddress4",    "expAddress5",     "expAddress6",     "expAddress7"
		  oSQL.AddValues txtAddress.Text, txtAddress2.Text, txtAddress3.Text, txtAddress4.Text, txtAddress5.Text, txtAddress6.Text, txtAddress7.Text
		  
		  oSQL.AddFields  "expClass",     "expClass2",     "expClass3",    "expClass4",     "expClass5",     "expClass6",      "expClass7"
		  oSQL.AddValues txtClass.Text, txtClass2.Text, txtClass3.Text, txtClass4.Text, txtClass5.Text, txtClass6.Text, txtClass7.Text
		  
		  oSQL.AddFields  "expTitle",     "expTitle2",     "expTitle3",    "expTitle4",     "expTitle5",     "expTitle6",     "expTitle7"
		  oSQL.AddValues txtTitle.Text, txtTitle2.Text, txtTitle3.Text, txtTitle4.Text, txtTitle5.Text, txtTitle6.Text, txtTitle7.Text
		  
		  oSQL.AddFields "expDescription",      "expDescription2",    "expDescription3",      "expDescription4",    "expDescription5",     "expDescription6", "    expDescription7"
		  oSQL.AddValues txtDescription.Text, txtDescription2.Text, txtDescription3.Text, txtDescription4.Text, txtDescription5.Text, txtDescription6.Text, txtDescription7.Text
		  
		  oSQL.AddFields "expDegree",     "expDegree2",     "expDegree3",     "expDegree4",     "expDegree5",     "expDegree6",     "expDegree7"
		  oSQL.AddValues txtDegree.Text, txtDegree2.Text, txtDegree3.Text, txtDegree4.Text, txtDegree5.Text, txtDegree6.Text, txtDegree7.Text
	...
	#tag Method, Flags = &h0
		Function ValidateAll() As Boolean
		  ...
		  lbReturnVal = SetValid(DidValidate(txtFrom), lbReturnVal)
		  lbReturnVal = SetValid(DidValidate(txtTo), lbReturnVal)
		  lbReturnVal = SetValid(DidValidate(txtAddress), lbReturnVal)
		  lbReturnVal = SetValid(DidValidate(txtClass), lbReturnVal)
		  lbReturnVal = SetValid(DidValidate(txtDegree), lbReturnVal)
