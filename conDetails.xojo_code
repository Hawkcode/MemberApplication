...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Function SaveMemInfo() As Boolean
		  ...
		  oSQL.AddValues txtResState.Text, txtResZip.Text, txtResCountry.Text, txtPhoneHome.Text
		  ...
		  oSQL.AddValues txtBusZip.Text, txtBusCountry.Text, txtPhoneBus.Text
